...
AKS_MAX_NODE_PODS="15"
AKS_NPOOL_NAME="sysnp01"
AKS_HAS_PRIVATE_DNS_ZONE="none"
AKS_NET_POLICY="azure"

## Key Vault
KV_NAME="kv-"$AKS_PURPOSE
KV_RG_NAME="rg-"$KV_NAME
KV_LOCATION=$AKS_LOCATION
KV_ENCRYPT_SET_ID_NAME="AKS-DES"
