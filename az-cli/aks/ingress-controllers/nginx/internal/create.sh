...
echo "Deploy AKS App 01"
kubectl apply -f 01-app01.yaml --namespace ingress-basic

echo "Deploy AKS App 02"
kubectl apply -f 02-app02.yaml --namespace ingress-basic

echo "Deploy AKS App Ingress Controller"
kubectl apply -f 03-app-ingress.yaml --namespace ingress-basic
