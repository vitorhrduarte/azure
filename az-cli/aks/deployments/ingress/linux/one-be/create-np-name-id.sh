...
helm install nginx-ingress ingress-nginx/ingress-nginx \
    ...
    --set controller.nodeSelector."agentpool"=usernpool \
    --set defaultBackend.nodeSelector."agentpool"=usernpool \
    --set controller.admissionWebhooks.patch.nodeSelector."agentpool"=usernpool \
