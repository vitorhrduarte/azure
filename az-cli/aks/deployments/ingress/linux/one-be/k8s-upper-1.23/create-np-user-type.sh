...
helm install nginx-ingress ingress-nginx/ingress-nginx \
    ...
    --set controller.nodeSelector."kubernetes\.azure\.com\/mode"=user \
    --set defaultBackend.nodeSelector."kubernetes\.azure\.com\/mode"=user \
    --set controller.admissionWebhooks.patch.nodeSelector."kubernetes\.azure\.com\/mode"=user \
