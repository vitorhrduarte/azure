...
AKS_VNET="main-"$AKS_CLUSTER_NAME
AKS_VNET_CIDR="$VNET_PREFIX.0.0/16"
AKS_SNET="snet-"$AKS_PURPOSE
AKS_SNET_CIDR="$VNET_PREFIX.0.0/22"
AKS_CLUSTER_SRV_CIDR="$VNET_PREFIX.4.0/23"
AKS_CLUSTER_DNS="$VNET_PREFIX.4.10"
AKS_CLUSTER_DOCKER_BRIDGE="172.17.0.1/16"
JUMP_VM_SUBNET_NAME="client-snet-"$AKS_PURPOSE
JUMP_VM_SNET_CIDR="$VNET_PREFIX.6.0/28"
JUMP_VM_PRIV_IP="$VNET_PREFIX.6.4/32"
...
APPGTW_SNET_CIDR="$VNET_PREFIX.200.0/24"
